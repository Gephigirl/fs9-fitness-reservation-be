...
export type ChargePointInput = z.infer<typeof chargePointSchema>["body"];
...
export type QueryMyPointHistoryInput = z.infer<
  typeof queryMyPointHistorySchema
>["query"];
...
export type QuerySellerSettlementInput = z.infer<
  typeof querySellerSettlementSchema
>["query"];
...
export type QuerySellerTransactionsInput = z.infer<
  typeof querySellerTransactionsSchema
>["query"];
...
export type QueryAdminPointHistoryInput = z.infer<
  typeof queryAdminPointHistorySchema
>["query"];
